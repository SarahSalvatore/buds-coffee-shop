    ...
    <section id="contact">
      ...
      <div className="contact-text-container">
        ...
        <p className="paragraph-text white-text">
          ...
          get in touch! You can contact us on Facebook, Instagram or by filling
          out our online contact form. We're always grateful to hear from our
          customers and are committed to providing the best possible service.
        </p>
        <p className="paragraph-text white-text">
